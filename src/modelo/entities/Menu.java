	...
	public static void menu() {
		...
		try {
			if (opcaoMenu.equals(menu[0])) {
				Object typeConvert = JOptionPane.showInputDialog(null, "Escolha a moeda para a qual você deseja girar seu dinheiro", "Moedas", -1, null, tipoMoedas, "");
				
			}else if (opcaoMenu.equals(menu[1])) {
				Object typeTemperatura = JOptionPane.showInputDialog(null, "Escolha a temperatura a qual voçê deseja converter", "Temperatura", -1, null, tipoTemperatura, "");
			}
			
			int resposta = JOptionPane.showConfirmDialog(null, "Deseja realizar outra conversão", "Conversão", JOptionPane.YES_NO_OPTION);
